...
public class V1LobbiesShopsSell extends APIEndpoint {

    final private Model model;

    public V1LobbiesShopsSell(Model model) {
        super("/api/v1/lobbies/shops/sell", patch);
        this.model = model;
    }
    ...
    protected Object patch(Request request, Response response) {
        ...
        boolean success = game.sellItem(session, transaction.slotFrom());
