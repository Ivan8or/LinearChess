package api.v1.lobbies.shops.sell;
...
public class V1LobbiesShopsSellTest {

    static final String RESOURCE_PATH = "api/v1/lobbies/shops/sell/endpoint/";
    ...
    public void unsupportedMethod() {
        V1LobbiesShopsSell endpoint = new V1LobbiesShopsSell(model);
    ...
    public void patch() {
        ...
        when(game.sellItem(session, transaction.slotFrom())).thenReturn(true);
